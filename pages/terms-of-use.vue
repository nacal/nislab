<template>
  <Section class="termsOfUse">
    <Title :title="`利用規約`" />
    <article class="termsOfUse__content">
      <p>
        この利用規約（以下，「本規約」といいます。）は，NISLAB（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>
      <h2>第1条（適用）</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          当社のサービスに関連して，反社会∂的勢力に対して直接または間接に利益を供与する行為
        </li>
